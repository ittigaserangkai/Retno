...
uses
  ...
  uCompany, uRetnoUnit, UTSBaseClass, StdCtrls;
...
//    class function GetRec(acOMpId: Integer; aUnitID : Integer = 0): TFDQuery;
    procedure GetRecCompany(var Code: TEdit; var Nm: TEdit);
    procedure GetRecApp(var Code: TEdit; var Nm: TEdit);
    procedure GetRecPrshType(var Code: TEdit; var Nm: TEdit);
    procedure GetRecKab(var Code: TEdit; var Nm: TEdit; APropId: Integer); overload;
    procedure GetRecKab(APropId: Integer; var Code: TEdit; var Nm: TEdit); overload;
    procedure GetRecProp(var Code: TEdit; var Nm: TEdit);
    procedure GetRecRegn(var Code: TEdit; var Nm: TEdit);
    procedure GetRecUnitType(var Code: TEdit; var Nm: TEdit);
...
procedure TUnit.GetRecCompany(var Code: TEdit; var Nm: TEdit);
begin
  Company.GetCurCompany(Code, Nm);
end;

procedure TUnit.GetRecApp(var Code: TEdit; var Nm: TEdit);
begin
//  App.GetCurApp(Code, Nm);
end;

procedure TUnit.GetRecRegn(var Code: TEdit; var Nm: TEdit);
begin
//  Regn.GetCurRegn(Code, Nm);
end;

procedure TUnit.GetRecProp(var Code: TEdit; var Nm: TEdit);
begin
//  Prop.GetCurProp(Code, Nm);
end;

procedure TUnit.GetRecKab(var Code: TEdit; var Nm: TEdit; APropId: Integer);
begin
//  Kab.GetCurKab(Code, Nm, APropId);
end;

procedure TUnit.GetRecKab(APropId: Integer; var Code: TEdit; var Nm: TEdit);
begin
  inherited;
//    Kab.GetCurKab(APropId, Code, Nm);
end;

procedure TUnit.GetRecPrshType(var Code: TEdit; var Nm: TEdit);
begin
//  UnitInfo.PrshType.GetCurPrshTipe(Code, Nm);
end;

procedure TUnit.GetRecUnitType(var Code: TEdit; var Nm: TEdit);
begin
