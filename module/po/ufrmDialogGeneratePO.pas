...
type
  TfrmDialogDetailGeneratePO = class(TfrmMasterDialogBrowse)
    ...
    cxgrdbclmnParentColumn1: TcxGridDBColumn;
    cxgrdbclmnParentColumn2: TcxGridDBColumn;
    cxgrdbclmnParentColumn3: TcxGridDBColumn;
    cxgrdbclmnParentColumn4: TcxGridDBColumn;
    cxgrdbclmnParentColumn5: TcxGridDBColumn;
    cxgrdbclmnParentColumn6: TcxGridDBColumn;
    cxgrdbclmnParentColumn7: TcxGridDBColumn;
    cxgrdbclmnParentColumn8: TcxGridDBColumn;
    cxgrdbclmnParentColumn9: TcxGridDBColumn;
    cxgrdbclmnParentColumn10: TcxGridDBColumn;
    cxgrdbclmnParentColumn11: TcxGridDBColumn;
    cxgrdbclmnParentColumn12: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn1: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn2: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn3: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn4: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn5: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn6: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn7: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn8: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn9: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn10: TcxGridDBColumn;
    cxgrdbclmnGridViewColumn11: TcxGridDBColumn;
