...
uses
  ...
  ufraFooterDialog2Button, ExtCtrls, SUIForm, Mask, JvToolEdit, SUIButton, DB;
...
type
  ...
  TfrmDialogSearchPO = class(TfrmMasterDialog)
    pnl1: TPanel;
...
uses uGTSUICommonDlg, uConn, uSearchPO,  suithemes;
...
begin
  ...
  begin
//    edt3.Text := 'PT. BAHAGIA SUMBER ABADI (SOLO)';
    btnSearchClick(self);
  end;
end;
...
procedure TfrmDialogSearchPO.btnSearchExit(Sender: TObject);
begin
  inherited;
  (Sender as TsuiButton).UIStyle := BlueGlass;
end;

procedure TfrmDialogSearchPO.footerDialogMasterbtnSaveExit(
  Sender: TObject);
begin
  inherited;
  (Sender as TsuiButton).UIStyle := BlueGlass;
...
procedure TfrmDialogSearchPO.footerDialogMasterbtnCloseExit(
  Sender: TObject);
begin
  inherited;
  (Sender as TsuiButton).UIStyle := BlueGlass;
...
procedure TfrmDialogSearchPO.btnSearchEnter(Sender: TObject);
begin
  inherited;
  (Sender as TsuiButton).UIStyle := DeepBlue;
end;

procedure TfrmDialogSearchPO.footerDialogMasterbtnSaveEnter(
  Sender: TObject);
begin
  inherited;
  (Sender as TsuiButton).UIStyle := DeepBlue;
...
procedure TfrmDialogSearchPO.footerDialogMasterbtnCloseEnter(
  Sender: TObject);
begin
  inherited;
  (Sender as TsuiButton).UIStyle := DeepBlue;
