unit ufrmGoodReceiving;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, ufrmMasterDialogBrowse, StdCtrls, ExtCtrls, SUIButton, Grids, BaseGrid,
  AdvGrid, ufraFooter5Button, JclStrings, Mask, JvToolEdit, JvEdit,
  ActnList, DateUtils, AdvObj, JvExStdCtrls, JvValidateEdit, JvExMask, AdvUtil,
...
function TfrmGoodsReceiving.SumColStringGrid(StrGrid:TAdvStringGrid;Col,RowStart,RowEnd:Integer):Real;
var i: Integer;
    hasil: Real;
begin
  hasil:= 0;
...
procedure TfrmGoodsReceiving.FormDestroy(Sender: TObject);
begin
  inherited;
...
procedure TfrmGoodsReceiving.strgGridCanEditCell(Sender: TObject; ARow,
...
procedure TfrmGoodsReceiving.strgGridGetEditorType(Sender: TObject; ACol,
...
procedure TfrmGoodsReceiving.strgGridGetCellColor(Sender: TObject; ARow,
...
procedure TfrmGoodsReceiving.strgGridClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmGoodsReceiving.strgGridRowChanging(Sender: TObject; OldRow,
...
procedure TfrmGoodsReceiving.strgGridCheckBoxClick(Sender: TObject; ACol,
...
procedure TfrmGoodsReceiving.FormActivate(Sender: TObject);
begin
  inherited;
...
procedure TfrmGoodsReceiving.strgGridGetAlignment(Sender: TObject; ARow,
...
procedure TfrmGoodsReceiving.strgGridGetFloatFormat(Sender: TObject; ACol,
...
procedure TfrmGoodsReceiving.strgGridKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  if Key = #13 then
...
procedure TfrmGoodsReceiving.btn2Enter(Sender: TObject);
begin
  inherited;
  (Sender as TcxButton).UIStyle := DeepBlue;
end;

procedure TfrmGoodsReceiving.btn2Exit(Sender: TObject);
begin
  inherited;
  (Sender as TcxButton).UIStyle := BlueGlass;
end;

procedure TfrmGoodsReceiving.btn1Exit(Sender: TObject);
begin
  inherited;
  (Sender as TcxButton).UIStyle := BlueGlass;
end;

procedure TfrmGoodsReceiving.btn1Enter(Sender: TObject);
begin
  inherited;
  (Sender as TcxButton).UIStyle := DeepBlue;
end;

procedure TfrmGoodsReceiving.btnCetakNPEnter(Sender: TObject);
begin
  inherited;
  (Sender as TcxButton).UIStyle := DeepBlue;
end;

procedure TfrmGoodsReceiving.btnCetakNPExit(Sender: TObject);
begin
  inherited;
  (Sender as TcxButton).UIStyle := BlueGlass;
end;
