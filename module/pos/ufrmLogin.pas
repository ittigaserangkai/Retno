...
type
  ...
  private
    ...
    FBalanceID: string;
    procedure SetAuthUser(UserID: string);
    procedure SetAuthSupervisor(UserID: string);
...
procedure TfrmLogin.SetAuthUser(UserID: string);
begin
...
procedure TfrmLogin.SetAuthSupervisor(UserID: string);
var
