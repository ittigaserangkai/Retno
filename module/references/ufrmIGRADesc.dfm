inherited frmIGRADesc: TfrmIGRADesc
  Caption = 'IGRA'#39's Description'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 16
  ...
  inline fraFooter5Button1: TfraFooter5Button
    ...
    inherited pnlFooter: TPanel
      ...
      inherited btnAdd: TsuiButton
        Caption = 'Add'
        Action = actAddIGRADesc
      end
      inherited btnUpdate: TsuiButton
        Caption = 'Edit'
        Action = actEditIGRADesc
      end
      inherited btnDelete: TsuiButton
        Action = actDeleteIGRADesc
      end
      inherited btnRefresh: TsuiButton
        Action = actRefreshIGRADesc
      end
    end
  ...
  object actlstIGRADesc: TActionList
    Left = 440
    Top = 16
    object actAddIGRADesc: TAction
      Caption = 'Add'
      OnExecute = actAddIGRADescExecute
    end
    object actEditIGRADesc: TAction
      Caption = 'Edit'
      OnExecute = actEditIGRADescExecute
    end
    object actDeleteIGRADesc: TAction
      Caption = 'Delete'
      OnExecute = actDeleteIGRADescExecute
    end
    object actRefreshIGRADesc: TAction
      Caption = 'Refresh'
      OnExecute = actRefreshIGRADescExecute
    end
  end
end
