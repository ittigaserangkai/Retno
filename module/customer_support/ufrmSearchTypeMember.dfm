inherited frmDialogSearchTypeMember: TfrmDialogSearchTypeMember
  Left = 340
  Top = 236
  Caption = 'Search TypeMember...'
  ClientHeight = 354
  ClientWidth = 416
  ...
  inherited pnlBody: TPanel
    ...
    object pnl1: TPanel
      ...
      object lbl2: TLabel
        ...
        Width = 96
        Height = 16
        Caption = 'TypeMember Name:'
      end
      object edtTypeMemberName: TEdit
        Left = 12
        Top = 24
        Width = 344
        Height = 22
        ...
        ParentCtl3D = False
        TabOrder = 0
        OnChange = edtTypeMemberNameChange
        OnKeyDown = edtTypeMemberNameKeyDown
      end
