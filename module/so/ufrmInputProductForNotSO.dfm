inherited frmInputProductForNotSO: TfrmInputProductForNotSO
  ...
  inline fraFooter5Button1: TfraFooter5Button
    ...
    inherited pnlFooter: TPanel
      ...
      inherited btnAdd: TsuiButton
        Caption = 'Add'
        Action = actAddProductNotForSO
      end
      inherited btnUpdate: TsuiButton
        Left = 457
        Caption = 'Edit'
        Visible = False
        Action = actEditProductNotForSO
      end
      inherited btnDelete: TsuiButton
        Left = 96
        Action = actDeleteProductNotForSO
      end
      inherited btnRefresh: TsuiButton
        Visible = False
        Action = actRefreshProductNotForSO
      end
    end
  ...
  object pnlSupplier: TPanel
    ...
    object cbpCode: TColumnComboBox
      Left = 468
      Top = 13
      Width = 69
      Height = 22
      TabStop = False
      OnCloseUp = cbpCodeCloseUp
      ColCount = 2
      Ctl3D = False
      DefaultRowHeight = 24
      DropDownCount = 8
  ...
  object actlstInputProductForNotSO: TActionList
    ...
    object actAddProductNotForSO: TAction
      Caption = 'Add'
      OnExecute = actAddProductNotForSOExecute
    end
    object actEditProductNotForSO: TAction
      Caption = 'Edit'
      OnExecute = actEditProductNotForSOExecute
    end
    object actDeleteProductNotForSO: TAction
      Caption = 'Delete'
      OnExecute = actDeleteProductNotForSOExecute
    end
    object actRefreshProductNotForSO: TAction
      Caption = 'Refresh'
      OnExecute = actRefreshProductNotForSOExecute
    end
  end
end
