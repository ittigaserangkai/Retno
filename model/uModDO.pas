...
uses
  ...
  System.Generics.Collections, uModSuplier, uModPO, uModSO,uModUnit, uModBarang,uModSatuan;
...
type
  ...
  published
    ...
    property DO_DESCRIPTION: Double read FDO_DESCRIPTION write FDO_DESCRIPTION;
    ...
    property DO_PAYMENT_DATE: Double read FDO_PAYMENT_DATE write
        FDO_PAYMENT_DATE;
