...
type
  ...
  private
    FDOTraderItems: TObjectList<TModReturTraderItem>;
    FRET_DATE: TDatetime;
  ...
  public
    property DOTraderItems: TObjectList<TModReturTraderItem> read FDOTraderItems
  ...
  published
    ...
    property RET_Organization: TModOrganization read FRET_Organization write
        FRET_Organization;
    property RET_POTrader: TModPOTrader read FRET_POTrader write FRET_POTrader;
  ...
  private
    ...
    FRETITEM_DOTRADER: TModReturTrader;
  ...
  published
    ...
    property RETITEM_DOTRADER: TModReturTrader read FRETITEM_DOTRADER write
        FRETITEM_DOTRADER;
