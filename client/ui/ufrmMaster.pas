...
type
  ...
  protected
    procedure DecorateFooter(var grid: TAdvStringGrid; c, r: integer);
  public
...
uses udmMain, DB, ufrmMain, ufraFooter5Button;
...
procedure TfrmMaster.DecorateFooter(var grid: TAdvStringGrid; c, r: integer);
begin
  with grid do begin
