...
uses
  ...
  Dialogs, StdCtrls, ComCtrls, ExtCtrls ,UConnection, IB, IdBaseComponent,
  IdMailBox;
...
implementation
uses urmsunit, uExportOfflinePOS, ugTSUICommonDlg, ufrmMain;
...
procedure TfrmExportOfflinePOS.FormCreate(Sender: TObject);
begin
