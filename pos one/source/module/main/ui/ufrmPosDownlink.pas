...
uses
  ...
  Dialogs, StdCtrls, IBDatabase, IB, IBQuery, ExtCtrls, uConnection ;
...
implementation
uses
  uRMSUnit, DB, uGTSUICommonDlg, ufrmMain;
{$R *.dfm}
...
begin
  ...
  sSQL  := 'SELECT BHJ_ID,'
          ...
          + ' WHERE (DATE_CREATE > '+ QuotDT(FLDateImpHrg)
          + ' or DATE_MODIFY > '+ QuotDT(FLDateImphrg) + ')'
...
begin
  ...
  sSQL  := 'SELECT *'
          ...
          + ' WHERE (DATE_CREATE > '+ QuotDT(FLDateImpBtl)
          + ' or DATE_MODIFY > '+ QuotDT(FLDateImpBtl) + ')'
...
begin
  ...
  sSQL  := 'SELECT *'
          + ' FROM VOUCHER'
          + ' WHERE (DATE_CREATE > '+ QuotDT(FLDateImpVou)
          + ' or DATE_MODIFY > '+ QuotDT(FLDateImpVou) + ')'
...
begin
  ...
  sSQL  := 'SELECT *'
          + ' FROM member'
          + ' WHERE (DATE_CREATE > '+ QuotDT(FLDateImpMem)
          + ' or DATE_MODIFY > '+ QuotDT(FLDateImpMem) + ')'
...
begin
  ...
  sSQL  := 'SELECT *'
          ...
          + ' WHERE (DATE_CREATE > '+ QuotDT(FLDateImpCrd)
          + ' or DATE_MODIFY > '+ QuotDT(FLDateImpCrd) + ')'
...
begin
  ...
  sSQL  := ' select * from BEGINNING_BALANCE'
          + ' WHERE (DATE_CREATE > '+ QuotDT(FLDateImpKsr)
          + ' or DATE_MODIFY > '+ QuotDT(FLDateImpKsr) + ')'
...
begin
  ...
  sSQL  := 'select * from barang where (DATE_CREATE > '+ QuotDT(FLDateImpHrg)
          + ' or DATE_MODIFY > '+ QuotDT(FLDateImpHrg) + ')';
