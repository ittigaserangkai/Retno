...
uses
  ...
  Dialogs, Menus, StdCtrls, ExtCtrls, Grids, BaseGrid, AdvGrid, AdvCGrid,
  AdvProgressBar;
...
uses
  uRMSUnit, Math, ufrmTransaksiKring;
...
procedure TfraDOKring.sgLookupDblClick(Sender: TObject);
var
  lKey: Word;
begin
  ...
  begin
    sgTransaksi.Visible := True;
	  pnlFooter.Visible := True;
    edNomorDO.Text := sgLookup.Cells[0,sgLookup.Row];
    lKey := VK_RETURN;
