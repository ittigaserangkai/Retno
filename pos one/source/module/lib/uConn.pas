...
begin
  _INIWriteString(FINIFilename,DB_POS,'DatabaseHost',FDBHost);
  _INIWriteString(FINIFilename,DB_POS,'DatabasePath',FDBPath);
  _INIWriteString(FINIFilename,DB_POS,'UserIB',_MakeReadable(_Encrypt(FUserIB,START_KEY,MULTI_KEY,ADD_KEY)));
  _INIWriteString(FINIFilename,DB_POS,'PasswordIB',_MakeReadable(_Encrypt(FPasswordIB,START_KEY,MULTI_KEY,ADD_KEY)));
  _INIWriteString(FINIFilename,DB_POS,'RoleIB',_MakeReadable(_Encrypt(FRoleIB,START_KEY,MULTI_KEY,ADD_KEY)));
end;
