inherited frmDailySalesReport: TfrmDailySalesReport
  ...
  Top = 133
  Height = 403
  Caption = 'Listing Daily Sales Report'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 16
  ...
  object actlstDSR: TActionList
    Left = 491
    Top = 257
    object actPrintDSR: TAction
      Caption = '&Print'
      OnExecute = actPrintDSRExecute
    end
    object actSaveDSRToFile: TAction
      Caption = '&Save To File'
      OnExecute = actSaveDSRToFileExecute
    end
  end
end
