inherited frmPODOReceive: TfrmPODOReceive
  Caption = 'frmPODOReceive'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 16
  inherited pnlBody: TPanel
    ...
    object edtPOFrom: TEdit
      ...
      ParentCtl3D = False
      TabOrder = 0
      OnKeyUp = edtPOFromKeyUp
    end
    object edtPOTo: TEdit
      Left = 242
      Top = 18
      Width = 119
      Height = 22
      ...
      ParentCtl3D = False
      TabOrder = 1
      OnKeyUp = edtPOToKeyUp
    end
  end
  inherited pnlHeader: TPanel
    inherited lblHeader: TLabel
      Width = 131
      Caption = 'LISTING PO/DO '#39'RECEIVE'#39
    end
  end
  ...
  object actlstPODOReceive: TActionList
    Left = 448
    Top = 70
    object actListPrintPODOReceive: TAction
      Caption = 'actListPrintPODOReceive'
      OnExecute = actListPrintPODOReceiveExecute
    end
  end
end
