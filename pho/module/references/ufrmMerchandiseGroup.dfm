inherited frmMerchandiseGroup: TfrmMerchandiseGroup
  ...
  inline fraFooter5Button1: TfraFooter5Button
    ...
    inherited pnlFooter: TPanel
      ...
      inherited btnAdd: TsuiButton
        Caption = 'Add'
        Action = actAddMerchanGroup
      end
      inherited btnUpdate: TsuiButton
        Caption = 'Edit'
        Action = actEditMerchanGroup
      end
      inherited btnDelete: TsuiButton
        Action = actDeleteMerchanGroup
      end
      inherited btnRefresh: TsuiButton
        Action = actRefreshMerchanGroup
      end
    end
  ...
  object actlstMerchandiseGroup: TActionList
    Left = 528
    Top = 8
    object actAddMerchanGroup: TAction
      Caption = 'Add'
      OnExecute = actAddMerchanGroupExecute
    end
    object actEditMerchanGroup: TAction
      Caption = 'Edit'
      OnExecute = actEditMerchanGroupExecute
    end
    object actDeleteMerchanGroup: TAction
      Caption = 'Delete'
      OnExecute = actDeleteMerchanGroupExecute
    end
    object actRefreshMerchanGroup: TAction
      Caption = 'Refresh'
      OnExecute = actRefreshMerchanGroupExecute
    end
  end
end
