inherited frmOutlet: TfrmOutlet
  ...
  inline fraFooter5Button1: TfraFooter5Button
    ...
    inherited pnlFooter: TPanel
      ...
      inherited btnUpdate: TsuiButton
        Caption = 'Edit'
        Action = actEditOutlet
      end
      inherited btnDelete: TsuiButton
        Action = actDeleteOutlet
      end
      inherited btnRefresh: TsuiButton
        Action = actRefreshOutlet
      end
    end
  ...
  object actlstOutlet: TActionList
    Left = 440
    Top = 16
    object actAddOutlet: TAction
      Caption = 'Add'
      OnExecute = actAddOutletExecute
    end
    object actEditOutlet: TAction
      Caption = 'Edit'
      OnExecute = actEditOutletExecute
    end
    object actDeleteOutlet: TAction
      Caption = 'Delete'
      OnExecute = actDeleteOutletExecute
    end
    object actRefreshOutlet: TAction
      Caption = 'Refresh'
      OnExecute = actRefreshOutletExecute
    end
  end
end
