inherited frmSupplier: TfrmSupplier
  ...
  inherited pnlBody: TPanel
    ...
    object edtKodeSupplier: TcxButtonEdit
      ...
      TabOrder = 0
      Text = '0'
      OnKeyDown = edtKodeSupplierKeyDown
      OnKeyPress = edtKodeSupplierKeyPress
      Width = 88
    end
    ...
    object cbpMerchanGroup: TComboBox
      ...
      ParentCtl3D = False
      TabOrder = 39
      OnChange = cbpMerchanGroupChange
    end
  ...
  inline fraFooter5Button1: TfraFooter5Button [2]
    ...
    inherited pnlFooter: TPanel
      ...
      inherited btnUpdate: TcxButton
        Action = actEditSupplier
      end
      inherited btnDelete: TcxButton
        Action = actDeleteSupplier
      end
      inherited btnRefresh: TcxButton
        Action = actRefreshSupplier
      end
    end
  ...
  object actlstSupplier: TActionList
    ...
    object actEditSupplier: TAction
      Caption = 'Edit'
      OnExecute = actEditSupplierExecute
    end
    object actDeleteSupplier: TAction
      Caption = 'Delete'
      OnExecute = actDeleteSupplierExecute
    end
    object actRefreshSupplier: TAction
      Caption = 'Refresh'
    end
    object actUpdateBank: TAction
      Caption = 'actUpdateBank'
      OnExecute = actUpdateBankExecute
    end
  end
  object ppmn1: TPopupMenu
    ...
    object AddMerchandiseGroup1: TMenuItem
      Caption = 'Add Merchandise Group'
      OnClick = AddMerchandiseGroup1Click
    end
  end
  object ppmn2: TPopupMenu
    OwnerDraw = True
    Left = 584
    Top = 406
    object DeleteSuplier: TMenuItem
      Caption = 'Delete Supplier'
      OnClick = DeleteSuplierClick
    end
    object DeleteMErchandise: TMenuItem
      Caption = 'Delete Merchandise Group'
      OnClick = DeleteMErchandiseClick
    end
  end
end
