inherited frmInputSupplierForNotSO: TfrmInputSupplierForNotSO
  ...
  inline fraFooter5Button1: TfraFooter5Button
    ...
    inherited pnlFooter: TPanel
      ...
      inherited btnAdd: TsuiButton
        Action = actAddSupplierForNotSO
      end
      inherited btnUpdate: TsuiButton
        Action = actEditSupplierForNotSO
      end
      inherited btnDelete: TsuiButton
        Action = actDeleteSupplierForNotSO
      end
      inherited btnRefresh: TsuiButton
        Action = actRefreshSupplierForNotSO
      end
    end
  ...
  object actlstInputSupplierForNotSO: TActionList
    Left = 544
    Top = 38
    object actAddSupplierForNotSO: TAction
      Caption = 'A&dd'
      OnExecute = actAddSupplierForNotSOExecute
    end
    object actEditSupplierForNotSO: TAction
      Caption = '&Edit'
      OnExecute = actEditSupplierForNotSOExecute
    end
    object actDeleteSupplierForNotSO: TAction
      Caption = 'Delete'
      OnExecute = actDeleteSupplierForNotSOExecute
    end
    object actRefreshSupplierForNotSO: TAction
      Caption = 'Refresh'
      OnExecute = actRefreshSupplierForNotSOExecute
    end
  end
end
